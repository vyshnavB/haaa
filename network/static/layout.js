...
function unlike_post(element) {
    ...
    .then(() => {
        ...
        count.innerHTML = value;
        element.querySelector('.svg-span').innerHTML = `
        <svg class="liked"  class="bi bi-star" width="1.1em" height="1.1em" xmlns="http://www.w3.org/2000/svg"  fill="currentColor"  viewBox="0 -1 16 16">
...
function unsave_post(element) {
    ...
    .then(() => {
        element.querySelector('.svg-span').innerHTML = `
        <svg width="1.1em" height="1.1em" viewBox="0.5 0 15 15" class="bi bi-bookmark" fill="#000" xmlns="http://www.w3.org/2000/svg">
